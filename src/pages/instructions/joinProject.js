        ...
        return (
            <View className='create'>
                ...
                <View className="steps">
                    ...
                    <Image src='http://www.epanel.cn/images/join1.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
                <View className="steps">
                    <View className="step">2. 名单选择</View>
                    <View>创建者若设置填报名单，则您点击填报项目链接后，先选择填报的名单，然后针对该名单填报信息。</View>
                    <Image src='http://www.epanel.cn/images/join2.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
                <View className="steps">
                    <View className="step">3. 填写密码</View>
                    <View>若创建者设置填报密码，则您点击项目链接后，输入填报密码。</View>
                    <Image src='http://www.epanel.cn/images/join3.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
                <View className="steps">
                    <View className="step">4. 填写/提交填报</View>
                    <View>您填报完成后，点击“提交填报”即可完成填报。</View>
                    <Image src='http://www.epanel.cn/images/join4.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
                <View className="steps">
                    <View className="step">5. 查看我参与项目</View>
                    <View>您可以登录“准报”小程序，查看参与的填报项目。</View>
                    <Image src='http://www.epanel.cn/images/join5.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
                <View className="steps">
                    <View className="step">6. 查看结果</View>
                    <View>填报提交后，您可点击“查看结果”查看填报答案记录。</View>
                    <Image src='http://www.epanel.cn/images/join6.png' mode="widthFix" style={{width:'100%'}}></Image>
                </View>
            </View>
        )
    }
